...
IN_PATH = 'Data/terms/Raw_Media_Headers.csv'
...
OUT_PATH = {'right': 'Data/terms/right_terms.json',
            'left': 'Data/terms/left_terms.json',
            'benign': 'Data/terms/benign_terms.json'}
...
def GenerateBenignTerms():
    with open('Data/diverse/common.json', 'r') as file:
        common_terms = json.load(file)
    file.close()

    with open('Data/diverse/countries.json', 'r') as file:
